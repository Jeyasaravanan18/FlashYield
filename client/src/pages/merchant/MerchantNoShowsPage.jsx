  ...
  return jsxs("div", {
    ...
    children: [
      jsxs("div", {
        ...
        children: [
          jsxs("div", { children: [jsx("p", { className: "text-xs font-semibold uppercase tracking-wider text-brand-600 mb-2", children: "Merchant operations" }), jsx("h1", { className: "text-3xl font-bold text-surface-50", children: "No-show management" }), jsx("p", { className: "text-sm text-surface-400 mt-1", children: "Track repeat no-shows and adjust pickup verification." })] }),
      ...
      isLoading ? jsx("div", { className: "card p-10 text-sm text-surface-400", children: "Loading no-show records..." }) : jsxs("div", {
        ...
        children: records.length === 0 ? jsx("div", { className: "card p-10 text-center text-surface-400", children: "No no-show records yet." }) : records.map((record) => jsxs("div", {
          ...
          children: [
            jsxs("div", { children: [jsx("h2", { className: "text-lg font-semibold text-surface-50", children: record.customerId || "Customer" }), jsx("p", { className: "text-sm text-surface-400 mt-1", children: `${record.count} recorded no-shows` })] }),
